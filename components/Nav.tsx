            ...
            <div className="header__social hidden sm:flex">
              <ul className="header__list header__list--socials flex space-x-4">
                <li className="header__list-item">
                  <Link href="https://youtube.com/channel/..." target="_blank" rel="noopener noreferrer" className="header__icon hover:text-amber-400 transition-colors cursor-pointer">
                    <FaYoutube className="w-6 h-6" />
                  </Link>
                </li>
                <li className="header__list-item">
                  <Link href="https://www.youtube.com/redirect?event=channel_description&redir_token=QUFFLUhqa1RjNGtfbHlfa0xSSk04TUxkRUxOOEtxejRlQXxBQ3Jtc0tsRE5ya2lzWWtNWldNdUhyeWRFNkdsOC1hbjNmdFJmckdOMzFCQUZVMzZWWkJjUFNqNkJSSXNjdDVvMXdsYXZZSVVfc0NuVFVoV2ZuemZnN1hjVkJHZ1RwejVJM0hyS2EyVUp5VFhNZGl2aWF4S0l1TQ&q=https%3A%2F%2Fwww.facebook.com%2Faletube2" target="_blank" rel="noopener noreferrer" className="header__icon hover:text-amber-400 transition-colors cursor-pointer">
                    <FaFacebookF className="w-6 h-6" />
                  </Link>
                </li>
                <li className="header__list-item">
                  <Link href="https://www.youtube.com/redirect?event=channel_description&redir_token=QUFFLUhqbGE5aHBjZ1RYTGllWUZDUWh4QnEzd1Q3akFaZ3xBQ3Jtc0tsZFdKWTNUeFZ0WEZYdW5nREdUb3U5QUpIUDZ0Y3VkNTJSamVSUVR0bkYtQ1NEWFNDSTdsdU9XYWJVZmFMWGFMMVFyRTFMTlhZR3FWWlh1X3JmVUVrYmpQRWNGdDItN2tHcnRXV2JIak5uck9vWjF0QQ&q=https%3A%2F%2Fwww.instagram.com%2Falexis_alex_ii%2F" target="_blank" rel="noopener noreferrer" className="header__icon hover:text-amber-400 transition-colors cursor-pointer">
                    <FaInstagram className="w-6 h-6" />
                  </Link>
                </li>
                <li className="header__list-item">
                  <Link href="https://www.youtube.com/redirect?event=channel_description&redir_token=QUFFLUhqbTZNUDJ3ejhjRThuN1VEMGpxVnpCV0ptSGtNZ3xBQ3Jtc0ttSTlvUXhzT0xRSGhtTmZPMlNqbUlwZVpKa01GMEpYenFrM3NfQXJSVTVFdVBQZTRRdmRjQzJtRUVyXzNUX1VFSjVfTkJvQ1N6TXpQV2k3Vl9GcG9DR0dxSVBrOVp1UnVuSU9KZW5GbW5ZTUhmbjFsdw&q=https%3A%2F%2Fwww.twitch.tv%2Falexis_alex_ii" target="_blank" rel="noopener noreferrer" className="header__icon hover:text-amber-400 transition-colors cursor-pointer">
                    <FaTwitch className="w-6 h-6" />
                  </Link>
                </li>
                <li className="header__list-item">
                  <Link href="https://discord.gg/" target="_blank" rel="noopener noreferrer" className="header__icon hover:text-amber-400 transition-colors cursor-pointer">
          ...
          <div className="header__section header__section--right flex items-center space-x-6 ">
            ...
            <nav className="header__nav hidden md:block">
              <ul className="header__list flex space-x-6 text-bold">
                <li className="header__list-item">
                  <Link href="https://www.youtube.com/@AleTube1st" className="header__link hover:text-amber-400 transition-colors cursor-pointer">Ale Tube</Link>
                </li>
                <li className="header__list-item">
                  <Link href="/Store" className="header__link hover:text-amber-400 transition-colors cursor-pointer">Merch</Link>
                </li>
                <li className="header__list-item">
                  <Link href="/Aboutme" className="header__link hover:text-amber-400 transition-colors cursor-pointer">About</Link>
                </li>
                <li className="header__list-item">
                  <Link href="/Blog" className="header__link hover:text-amber-400 transition-colors cursor-pointer">Blog</Link>
                </li>
              </ul>
            </nav>
          </div>
